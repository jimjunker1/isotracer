...
data {
  ...
  /// * ODE tuning
  // https://mc-stan.org/docs/2_18/stan-users-guide/control-parameters-for-ode-solving.html
  real rel_tol;
  real abs_tol;
  int max_steps;
  int solver_selector; // 1 is rk45, other is bdf
